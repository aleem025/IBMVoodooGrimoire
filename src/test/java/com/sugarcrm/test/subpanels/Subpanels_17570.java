...
public class Subpanels_17570 extends SugarTest {
	...
	/**
	 * Verify subpanel predefined filters - Assigned to Me
	 * 
	 * @throws Exception
	 */
	@Test
	public void execute() throws Exception {
		...
		// Filter on My Favorites to clear the list, as the record is not marked
		// as a favorite
		...
		filterFilterDropdown.set("Assigned to Me");
		// Pause until screen is rendered
		VoodooUtils.pause(2000);
