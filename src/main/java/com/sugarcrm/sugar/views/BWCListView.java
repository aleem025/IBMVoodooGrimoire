...
public class BWCListView extends View implements IListView {
	...
	public BWCListView(RecordsModule parentModule) throws Exception {
		...
		addControl("selectDropdown", "a", "id", "select_link");
		...
		addControl("exportButton", "a", "css", ".export_listview_top ");
		...
		for(int i=1; i <= 99; i++){
			...
			addControl(link, "a", "css", currentRow + " td:nth-of-type(4) a");
...
*/	}
	 ...
	 * @param value the string value you want to verify is contained within the
	 * field.
	 * @throws Exception
	 * @deprecated Not yet implemented.
	 */
	public void verifyField(int row, String field, String value) throws Exception {
		VoodooUtils.voodoo.log.severe("Method verifyField() not implemented.");
		// TODO: Implement using logic similar to below.  Remove comment and
		// commented code when method is implemented.
/*		String cell = "div[data-voodoo-name='recordlist'] tbody " +
			"tr:nth-of-type(" + row + ") " + "td." + field;
		new VoodooControl("td", "css", cell).assertContains(value, true);
*/	}
