...
public class Accounts_17808 extends SugarTest {
	...
	/**
	 * Verify clearing of search criteria from search field after changing
	 * filter - record view 
	 * @throws Exception
	 */
	...
	public void execute() throws Exception {
		...
		new VoodooControl("div", "css", "div.main-content div[data-voodoo-name='Contacts']").assertContains(filter1, true);
		new VoodooControl("div", "css", "div.main-content div[data-voodoo-name='Contacts']").assertContains(filter2, true);
