...
public class Accounts_0006 extends SugarTest {
	FieldSet account;
	...
	public void execute() throws Exception {
		...
		sugar.noteCreateView.createNoteLibSub();
		VoodooUtils.switchToBWCFrame();
		sugar.taskCreateView.createTaskLibSub();
		VoodooUtils.switchToBWCFrame();
		sugar.callCreateView.createCallLibSub();
		VoodooUtils.switchToBWCFrame();
		sugar.contactCreateView.createContactLibSub();
