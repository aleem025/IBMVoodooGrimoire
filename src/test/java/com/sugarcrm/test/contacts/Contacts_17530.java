...
public class Contacts_17530 extends SugarTest {
	...
	public void execute() throws Exception {
		...
		// Check the unique identifier on the contacts 'list view' contains the "contact name" of default state for "activities stream/list view" toggle button
		new VoodooControl("th", "css", "th[data-fieldname='full_name']").assertContains("Contact Name", true);
